...
"preview_summary": {
 ...
 "what_email_can_court_use": {
  ...
  "already_submitted": {
    ...
    "es": "**Ya se ha enviado una solicitud para las siguientes citas a continuación. Si sus circunstancias financieras han cambiado, espere al menos 24 horas para volver a enviar.**",
    "zh-s": "",
    "zh-t": ""
  },
