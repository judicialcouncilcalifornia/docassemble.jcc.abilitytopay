translations = {
  ...
  * Si quiere disputar la multa o resolver su multa en persona, comuníquese con su corte. Consulte su aviso recordatorio.
  ...
  "which_is_your_citation": {
    ...
    "es":"Which of the following is your citation? (sp)"
  },

  "select_citation": {
    "en":"Select the citation from the list below.",
    "es":"Select the citation from the list below.(sp)"
  },
...
Esté preparado para compartir información sobre sus ingresos, gastos mensuales y cualquier beneficio público que recibe actualmente. Igualmente, sus respuestas serán revisadas por un funcionario judicial como ocurriría si viniera a la corte en persona.
  ...
  "other_benefit_name": {
    ...
    "es":"What's the other public benefit you receive?"
  },
  ...
  "total_additional_expenses": {
    ...
    "es":"What is the total monthly cost of these additional expenses? (sp)"
  },
  ...
  "administrative_fees": {
    ...
    "es":"Note: Your court may charge administrative fees for setting up a payment plan or community service work plan. (sp)"
  },
...
* a guardar silencio y no atestiguar ni incriminarse.
  ...
  "what_email_can_court_use": {
    ...
    "es":"What email address can the Court use to communicate about your request? (sp)"
  },

  "email_again": {
    "en":"Please enter your email address again.",
    "es":"Please enter your email address again. (sp)"
  },
  ...
  "emails_match": {
    ...
    "es":'<span class="text-success">E-mail addresses match! (sp)</span>'
  },


  "penalty_of_perjury": {
    "en":"By checking this box, I declare under penalty of perjury that what I have reported is true.",
    "es":"By checking this box, I declare under penalty of perjury that what I have reported is true. (sp)"
  },

  "cant_continue_email": {
    "en":"You cannot continue until you confirm your e-mail address.",
    "es":"You cannot continue until you confirm your e-mail address. (sp)"
  },

  "cant_continue_sign": {
    "en":"You cannot continue until you electronically sign under penalty of perjury.",
    "es":"You cannot continue until you electronically sign under penalty of perjury. (sp)"
  },
  ...
  "expect_response": {
    ...
    "es":"*Expect a response from the court by email in 10 business days. If you don't get a notification please contact the Court. (sp)*"
  },

  "restart": {
    "en":"Start Another Request",
    "es":"Start Another Request (sp)"
  }
