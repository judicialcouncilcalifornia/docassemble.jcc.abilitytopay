...
$(document).ready(function() {
    ...
    (function () {
        ...
        div.outerHTML = "<iframe class='iframeBot' id='iframeBot' width='140px' height='60px' style='position:fixed; bottom: 0; right: 10px; border-radius: 20px; border: 0; background: unset; z-index: 2000;' src='https://jccatpchatbotwebprod.azurewebsites.net/chat.html'></iframe>";
    }());
